...
public class Ports {
    ...
    public static String userDel = userUrl + "delete";
    public static String userGetAll = userUrl + "getAll";
    public static String userSilence = userUrl + "silence";
     ...
     * 餐品管理
     */
    public static String dishAdd = dish + "add";
    public static String dishDel = dish + "delete";
    public static String dishModify = dish + "modify";
    ...
    public static String windowInf = api + "window/getInf";
    ...
    public static String postsGetBad = postsUrl + "getBad";
