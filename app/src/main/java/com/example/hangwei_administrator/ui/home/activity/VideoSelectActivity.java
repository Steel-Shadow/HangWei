...
import com.example.hangwei_administrator.ui.home.adapter.VideoSelectAdapter;
            ...
            if (mSelectVideo.isEmpty()) {
                ...
                CameraActivity.start(this, true, new CameraActivity.OnCameraListener() {
                    ...
                    public void onError(String details) {
                        ToastUtil.toast(details, ToastConst.errorStyle);
                    }
                });
                return;
            }
    ...
    public void onChildClick(RecyclerView recyclerView, View childView, int position) {
        if (childView.getId() == R.id.fl_video_select_check) {
            ...
            if (!file.isFile()) {
                ...
                ToastUtil.toast("无法选中，该视频已经被删除", ToastConst.errorStyle);
                return;
            }
            ...
            if (mMaxSelect == 1 && mSelectVideo.size() == 1) {
                ...
                ToastUtil.toast(String.format(getString(R.string.video_select_max_hint), mMaxSelect), ToastConst.hintStyle);
            }
            mAdapter.notifyItemChanged(position);
        }
    }
