...
import com.example.hangwei_administrator.action.StatusAction;
import com.example.hangwei_administrator.aop.Log;
import com.example.hangwei_administrator.aop.Permissions;
...
import com.example.hangwei_administrator.other.GridSpaceDecoration;
import com.example.hangwei_administrator.ui.home.adapter.ImageSelectAdapter;
import com.example.hangwei_administrator.dialog.AlbumDialog;
import com.example.hangwei_administrator.utils.ToastUtil;
import com.example.hangwei_administrator.widget.layout.StatusLayout;
import com.hjq.bar.TitleBar;
import com.hjq.permissions.OnPermissionCallback;
import com.hjq.permissions.Permission;
import com.hjq.permissions.XXPermissions;
import com.example.hangwei_administrator.widget.view.FloatActionButton;
                ...
                XXPermissions.with(this)
                        ...
                        .request(new OnPermissionCallback() {
                            ...
                            public void onGranted(@NonNull List<String> permissions, boolean allGranted) {
                                if (allGranted) {
                                    // 点击拍照
                                    CameraActivity.start(ImageSelectActivity.this, new CameraActivity.OnCameraListener() {
                                        @Override
                                        ...
                                        public void onError(String details) {
                                            ToastUtil.toast(details, ToastConst.warnStyle);
                                        }
                                    });
                                }
                            }
                            ...
                            public void onDenied(@NonNull List<String> permissions, boolean doNotAskAgain) {
                                ...
                                if (doNotAskAgain) {
                                    ...
                                    ToastUtil.toast("相机权限获取失败", ToastConst.warnStyle);
                                }
                            }
                        });
                return;
    ...
    public void onChildClick(RecyclerView recyclerView, View childView, int position) {
        if (childView.getId() == R.id.fl_image_select_check) {
            ...
            if (!file.isFile()) {
                ...
                ToastUtil.toast(String.valueOf(R.string.image_select_error), ToastConst.warnStyle);
                return;
            }
            ...
            if (mMaxSelect == 1 && mSelectImage.size() == 1) {
                ...
                ToastUtil.toast(String.format(getString(R.string.image_select_max_hint), mMaxSelect),
                        ToastConst.warnStyle);
            }
            mAdapter.notifyItemChanged(position);
        }
    }
