package com.example.hangwei_administrator.other;
...
public abstract class PermissionCallback implements OnPermissionCallback {
    ...
    public void onDenied(List<String> permissions, boolean never) {
        ...
        if (permissions.size() == 1 && Permission.ACCESS_BACKGROUND_LOCATION.equals(permissions.get(0))) {
            ToastUtil.toast(String.valueOf(R.string.common_permission_fail_4), ToastConst.warnStyle);
            return;
        }

        ToastUtil.toast(String.valueOf(R.string.common_permission_fail_1), ToastConst.warnStyle);
    }
