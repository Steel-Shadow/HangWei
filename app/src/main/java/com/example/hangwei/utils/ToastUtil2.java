...
public final class ToastUtil2 {
    ...
    public static void setGravity(int gravity, int xOffset, int yOffset) {
        ToastUtil2.gravity = gravity;
        ToastUtil2.xOffset = xOffset;
        ToastUtil2.yOffset = yOffset;
    }
    ...
    public static void setBackgroundColor(@ColorInt int backgroundColor) {
        ToastUtil2.backgroundColor = backgroundColor;
    }
    ...
    public static void setBgResource(@DrawableRes int bgResource) {
        ToastUtil2.bgResource = bgResource;
    }
    ...
    public static void setMessageColor(@ColorInt int messageColor) {
        ToastUtil2.messageColor = messageColor;
    }
